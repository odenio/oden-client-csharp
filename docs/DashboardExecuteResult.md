# Oden.Model.DashboardExecuteResult
...
**FiltersApplied** | **Dictionary&lt;string, Object&gt;** | Echo of the filter dimensions that were applied, resolved to human-readable values where possible (e.g. line names instead of IDs).  | [optional] 
...
**Rows** | **List&lt;Dictionary&lt;string, Object&gt;&gt;** | Row data as objects keyed by column name (not positional arrays). Values are typed JSON natively. Null when the module errored.  | [optional] 
