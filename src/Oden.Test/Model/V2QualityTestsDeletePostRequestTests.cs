...
{
    /// <summary>
    ///  Class for testing V2QualityTestsDeletePostRequest
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class V2QualityTestsDeletePostRequestTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for V2QualityTestsDeletePostRequest
        //private V2QualityTestsDeletePostRequest instance;

        public V2QualityTestsDeletePostRequestTests()
        {
            // TODO uncomment below to create an instance of V2QualityTestsDeletePostRequest
            //instance = new V2QualityTestsDeletePostRequest();
        }
        ...
        /// <summary>
        /// Test an instance of V2QualityTestsDeletePostRequest
        /// </summary>
        [Fact]
        public void V2QualityTestsDeletePostRequestInstanceTest()
        {
            // TODO uncomment below to test "IsType" V2QualityTestsDeletePostRequest
            //Assert.IsType<V2QualityTestsDeletePostRequest>(instance);
        }
