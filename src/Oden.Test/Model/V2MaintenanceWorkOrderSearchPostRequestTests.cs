...
{
    /// <summary>
    ///  Class for testing V2MaintenanceWorkOrderSearchPostRequest
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class V2MaintenanceWorkOrderSearchPostRequestTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for V2MaintenanceWorkOrderSearchPostRequest
        //private V2MaintenanceWorkOrderSearchPostRequest instance;

        public V2MaintenanceWorkOrderSearchPostRequestTests()
        {
            // TODO uncomment below to create an instance of V2MaintenanceWorkOrderSearchPostRequest
            //instance = new V2MaintenanceWorkOrderSearchPostRequest();
        }
        ...
        /// <summary>
        /// Test an instance of V2MaintenanceWorkOrderSearchPostRequest
        /// </summary>
        [Fact]
        public void V2MaintenanceWorkOrderSearchPostRequestInstanceTest()
        {
            // TODO uncomment below to test "IsType" V2MaintenanceWorkOrderSearchPostRequest
            //Assert.IsType<V2MaintenanceWorkOrderSearchPostRequest>(instance);
        }
