...
{
    /// <summary>
    ///  Class for testing V2ScrapYieldSetPostRequest
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class V2ScrapYieldSetPostRequestTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for V2ScrapYieldSetPostRequest
        //private V2ScrapYieldSetPostRequest instance;

        public V2ScrapYieldSetPostRequestTests()
        {
            // TODO uncomment below to create an instance of V2ScrapYieldSetPostRequest
            //instance = new V2ScrapYieldSetPostRequest();
        }
        ...
        /// <summary>
        /// Test an instance of V2ScrapYieldSetPostRequest
        /// </summary>
        [Fact]
        public void V2ScrapYieldSetPostRequestInstanceTest()
        {
            // TODO uncomment below to test "IsType" V2ScrapYieldSetPostRequest
            //Assert.IsType<V2ScrapYieldSetPostRequest>(instance);
        }
