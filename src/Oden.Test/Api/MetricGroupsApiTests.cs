...
{
    /// <summary>
    ///  Class for testing MetricGroupsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class MetricGroupsApiTests : IDisposable
    {
        private MetricGroupsApi instance;

        public MetricGroupsApiTests()
        {
            instance = new MetricGroupsApi();
        }
        ...
        /// <summary>
        /// Test an instance of MetricGroupsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' MetricGroupsApi
            //Assert.IsType<MetricGroupsApi>(instance);
        }

        /// <summary>
        /// Test V2MetricGroupSearchPost
        /// </summary>
        [Fact]
        public void V2MetricGroupSearchPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //MetricGroup metricGroup = null;
            //var response = instance.V2MetricGroupSearchPost(metricGroup);
            //Assert.IsType<List<MetricGroup>>(response);
        }
    }
}
