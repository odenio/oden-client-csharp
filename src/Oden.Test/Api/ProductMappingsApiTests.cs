...
{
    /// <summary>
    ///  Class for testing ProductMappingsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class ProductMappingsApiTests : IDisposable
    {
        private ProductMappingsApi instance;

        public ProductMappingsApiTests()
        {
            instance = new ProductMappingsApi();
        }
        ...
        /// <summary>
        /// Test an instance of ProductMappingsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' ProductMappingsApi
            //Assert.IsType<ProductMappingsApi>(instance);
        }

        /// <summary>
        /// Test V2ProductMappingSearchPost
        /// </summary>
        [Fact]
        public void V2ProductMappingSearchPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //ProductMapping productMapping = null;
            //var response = instance.V2ProductMappingSearchPost(productMapping);
            //Assert.IsType<List<ProductMapping>>(response);
        }

        /// <summary>
        /// Test V2ProductMappingSetPost
        /// </summary>
        [Fact]
        public void V2ProductMappingSetPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //ProductMapping productMapping = null;
            //instance.V2ProductMappingSetPost(productMapping);
        }
    }
}
