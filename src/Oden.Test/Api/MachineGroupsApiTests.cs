...
{
    /// <summary>
    ///  Class for testing MachineGroupsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class MachineGroupsApiTests : IDisposable
    {
        private MachineGroupsApi instance;

        public MachineGroupsApiTests()
        {
            instance = new MachineGroupsApi();
        }
        ...
        /// <summary>
        /// Test an instance of MachineGroupsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' MachineGroupsApi
            //Assert.IsType<MachineGroupsApi>(instance);
        }

        /// <summary>
        /// Test V2FactorySearchPost
        /// </summary>
        [Fact]
        public void V2FactorySearchPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Factory factory = null;
            //var response = instance.V2FactorySearchPost(factory);
            //Assert.IsType<List<Factory>>(response);
        }

        /// <summary>
        /// Test V2LineSearchPost
        /// </summary>
        [Fact]
        public void V2LineSearchPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Line line = null;
            //var response = instance.V2LineSearchPost(line);
            //Assert.IsType<List<Line>>(response);
        }
    }
}
