...
namespace Oden.Test.Api
{
    ...
    public class DashboardsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ExecuteDashboard
        /// </summary>
        [Fact]
        public void ExecuteDashboardTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //DashboardExecuteRequest dashboardExecuteRequest = null;
            //var response = instance.ExecuteDashboard(dashboardExecuteRequest);
            //Assert.IsType<List<DashboardExecuteResult>>(response);
        }
    }
}
