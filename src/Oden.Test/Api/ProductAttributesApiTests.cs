...
{
    /// <summary>
    ///  Class for testing ProductAttributesApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class ProductAttributesApiTests : IDisposable
    {
        private ProductAttributesApi instance;

        public ProductAttributesApiTests()
        {
            instance = new ProductAttributesApi();
        }
        ...
        /// <summary>
        /// Test an instance of ProductAttributesApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' ProductAttributesApi
            //Assert.IsType<ProductAttributesApi>(instance);
        }

        /// <summary>
        /// Test V2ProductAttributeSearchPost
        /// </summary>
        [Fact]
        public void V2ProductAttributeSearchPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //ProductAttribute productAttribute = null;
            //var response = instance.V2ProductAttributeSearchPost(productAttribute);
            //Assert.IsType<List<ProductAttribute>>(response);
        }

        /// <summary>
        /// Test V2ProductAttributeSetPost
        /// </summary>
        [Fact]
        public void V2ProductAttributeSetPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //ProductAttribute productAttribute = null;
            //var response = instance.V2ProductAttributeSetPost(productAttribute);
            //Assert.IsType<List<ProductAttribute>>(response);
        }
    }
}
