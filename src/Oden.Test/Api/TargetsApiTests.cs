...
{
    /// <summary>
    ///  Class for testing TargetsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class TargetsApiTests : IDisposable
    {
        private TargetsApi instance;

        public TargetsApiTests()
        {
            instance = new TargetsApi();
        }
        ...
        /// <summary>
        /// Test an instance of TargetsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' TargetsApi
            //Assert.IsType<TargetsApi>(instance);
        }

        /// <summary>
        /// Test V2TargetSearchPost
        /// </summary>
        [Fact]
        public void V2TargetSearchPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Target target = null;
            //var response = instance.V2TargetSearchPost(target);
            //Assert.IsType<List<Target>>(response);
        }

        /// <summary>
        /// Test V2TargetSetPost
        /// </summary>
        [Fact]
        public void V2TargetSetPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Target target = null;
            //var response = instance.V2TargetSetPost(target);
            //Assert.IsType<Target>(response);
        }
    }
}
