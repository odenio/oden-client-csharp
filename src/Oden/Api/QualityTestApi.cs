...
namespace Oden.Api
{
    ...
    /// </summary>
    public interface IQualityTestApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IQualityTestApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IQualityTestApi : IQualityTestApiSync, IQualityTestApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class QualityTestApi : IDisposable, IQualityTestApi
    {
        private Oden.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="QualityTestApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public QualityTestApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public QualityTestApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QualityTestApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public QualityTestApi(Oden.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public QualityTestApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public QualityTestApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public QualityTestApi(HttpClient client, Oden.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public QualityTestApi(Oden.Client.ISynchronousClient client, Oden.Client.IAsynchronousClient asyncClient, Oden.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public Oden.Client.ApiResponse<Object> V2QualityTestDeletePostWithHttpInfo(QualityTest qualityTest)
        {
            ...
            localVarRequestOptions.Data = qualityTest;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/v2/quality_test/delete", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<Object>> V2QualityTestDeletePostWithHttpInfoAsync(QualityTest qualityTest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/v2/quality_test/delete", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Oden.Client.ApiResponse<Object> V2QualityTestSearchPostWithHttpInfo(QualityTest qualityTest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/v2/quality_test/search", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<Object>> V2QualityTestSearchPostWithHttpInfoAsync(QualityTest qualityTest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/v2/quality_test/search", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Oden.Client.ApiResponse<Object> V2QualityTestSetPostWithHttpInfo(QualityTest qualityTest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/v2/quality_test/set", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<Object>> V2QualityTestSetPostWithHttpInfoAsync(QualityTest qualityTest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/v2/quality_test/set", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
