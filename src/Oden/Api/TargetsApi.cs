...
namespace Oden.Api
{
    ...
    /// </summary>
    public interface ITargetsApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITargetsApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITargetsApi : ITargetsApiSync, ITargetsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TargetsApi : IDisposable, ITargetsApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public TargetsApi() : this((string)null)
        {
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetsApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public TargetsApi(Oden.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public TargetsApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public TargetsApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public TargetsApi(HttpClient client, Oden.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public TargetsApi(Oden.Client.ISynchronousClient client, Oden.Client.IAsynchronousClient asyncClient, Oden.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public Oden.Client.ApiResponse<List<Target>> V2TargetSearchPostWithHttpInfo(Target target)
        {
            ...
            localVarRequestOptions.Data = target;
            ...
            var localVarResponse = this.Client.Post<List<Target>>("/v2/target/search", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<List<Target>>> V2TargetSearchPostWithHttpInfoAsync(Target target, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<Target>>("/v2/target/search", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Oden.Client.ApiResponse<Target> V2TargetSetPostWithHttpInfo(Target target)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Target>("/v2/target/set", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<Target>> V2TargetSetPostWithHttpInfoAsync(Target target, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Target>("/v2/target/set", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
