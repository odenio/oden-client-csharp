...
namespace Oden.Api
{
    ...
    /// </summary>
    public interface IProductAttributesApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IProductAttributesApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IProductAttributesApi : IProductAttributesApiSync, IProductAttributesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ProductAttributesApi : IDisposable, IProductAttributesApi
    {
        private Oden.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ProductAttributesApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public ProductAttributesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public ProductAttributesApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductAttributesApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public ProductAttributesApi(Oden.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public ProductAttributesApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ProductAttributesApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ProductAttributesApi(HttpClient client, Oden.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ProductAttributesApi(Oden.Client.ISynchronousClient client, Oden.Client.IAsynchronousClient asyncClient, Oden.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public Oden.Client.ApiResponse<List<ProductAttribute>> V2ProductAttributeSearchPostWithHttpInfo(ProductAttribute productAttribute)
        {
            ...
            localVarRequestOptions.Data = productAttribute;
            ...
            var localVarResponse = this.Client.Post<List<ProductAttribute>>("/v2/product_attribute/search", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<List<ProductAttribute>>> V2ProductAttributeSearchPostWithHttpInfoAsync(ProductAttribute productAttribute, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<ProductAttribute>>("/v2/product_attribute/search", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Oden.Client.ApiResponse<List<ProductAttribute>> V2ProductAttributeSetPostWithHttpInfo(ProductAttribute productAttribute)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<ProductAttribute>>("/v2/product_attribute/set", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<List<ProductAttribute>>> V2ProductAttributeSetPostWithHttpInfoAsync(ProductAttribute productAttribute, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<ProductAttribute>>("/v2/product_attribute/set", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
