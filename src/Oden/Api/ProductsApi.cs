...
namespace Oden.Api
{
    ...
    public partial class ProductsApi : IDisposable, IProductsApi
    {
        ...
        /// <returns></returns>
        public ProductsApi(Oden.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ProductsApi(HttpClient client, Oden.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ProductsApi(Oden.Client.ISynchronousClient client, Oden.Client.IAsynchronousClient asyncClient, Oden.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public Oden.Client.ApiResponse<Object> V2ProductDeletePostWithHttpInfo(Product product)
        {
            ...
            var localVarResponse = this.Client.Post<Object>("/v2/product/delete", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<Object>> V2ProductDeletePostWithHttpInfoAsync(Product product, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/v2/product/delete", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Oden.Client.ApiResponse<List<Product>> V2ProductSearchPostWithHttpInfo(Product product)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<Product>>("/v2/product/search", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<List<Product>>> V2ProductSearchPostWithHttpInfoAsync(Product product, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<Product>>("/v2/product/search", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Oden.Client.ApiResponse<Object> V2ProductSetPostWithHttpInfo(Product product)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/v2/product/set", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<Object>> V2ProductSetPostWithHttpInfoAsync(Product product, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/v2/product/set", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
