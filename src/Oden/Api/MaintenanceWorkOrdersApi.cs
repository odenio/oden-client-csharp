...
namespace Oden.Api
{
    ...
    /// </summary>
    public interface IMaintenanceWorkOrdersApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMaintenanceWorkOrdersApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMaintenanceWorkOrdersApi : IMaintenanceWorkOrdersApiSync, IMaintenanceWorkOrdersApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MaintenanceWorkOrdersApi : IDisposable, IMaintenanceWorkOrdersApi
    {
        private Oden.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceWorkOrdersApi"/> class.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        /// <returns></returns>
        public MaintenanceWorkOrdersApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public MaintenanceWorkOrdersApi(string basePath)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceWorkOrdersApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public MaintenanceWorkOrdersApi(Oden.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public MaintenanceWorkOrdersApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public MaintenanceWorkOrdersApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public MaintenanceWorkOrdersApi(HttpClient client, Oden.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public MaintenanceWorkOrdersApi(Oden.Client.ISynchronousClient client, Oden.Client.IAsynchronousClient asyncClient, Oden.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        public Oden.Client.ApiResponse<List<MaintenanceWorkOrder>> DeleteMaintenanceWorkOrderWithHttpInfo(MaintenanceWorkOrder maintenanceWorkOrder)
        {
            ...
            localVarRequestOptions.Data = maintenanceWorkOrder;
            ...
            var localVarResponse = this.Client.Post<List<MaintenanceWorkOrder>>("/v2/maintenance_work_order/delete", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<List<MaintenanceWorkOrder>>> DeleteMaintenanceWorkOrderWithHttpInfoAsync(MaintenanceWorkOrder maintenanceWorkOrder, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<MaintenanceWorkOrder>>("/v2/maintenance_work_order/delete", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Oden.Client.ApiResponse<List<MaintenanceWorkOrder>> SearchMaintenanceWorkOrdersWithHttpInfo(SearchMaintenanceWorkOrdersRequest searchMaintenanceWorkOrdersRequest)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<MaintenanceWorkOrder>>("/v2/maintenance_work_order/search", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<List<MaintenanceWorkOrder>>> SearchMaintenanceWorkOrdersWithHttpInfoAsync(SearchMaintenanceWorkOrdersRequest searchMaintenanceWorkOrdersRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<MaintenanceWorkOrder>>("/v2/maintenance_work_order/search", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Oden.Client.ApiResponse<MaintenanceWorkOrder> SetMaintenanceWorkOrderWithHttpInfo(MaintenanceWorkOrder maintenanceWorkOrder)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<MaintenanceWorkOrder>("/v2/maintenance_work_order/set", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<MaintenanceWorkOrder>> SetMaintenanceWorkOrderWithHttpInfoAsync(MaintenanceWorkOrder maintenanceWorkOrder, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<MaintenanceWorkOrder>("/v2/maintenance_work_order/set", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
