...
namespace Oden.Api
{
    ...
    public interface IDashboardsApiSync : IApiAccessor
    {
        ...
        /// <param name="dashboardExecuteRequest"></param>
        /// <returns>List&lt;DashboardExecuteResult&gt;</returns>
        ...
        /// <exception cref="Oden.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dashboardExecuteRequest"></param>
        /// <returns>ApiResponse of List&lt;DashboardExecuteResult&gt;</returns>
        ApiResponse<List<DashboardExecuteResult>> ExecuteDashboardWithHttpInfo(DashboardExecuteRequest dashboardExecuteRequest);
    ...
    public interface IDashboardsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of List&lt;DashboardExecuteResult&gt;</returns>
        System.Threading.Tasks.Task<List<DashboardExecuteResult>> ExecuteDashboardAsync(DashboardExecuteRequest dashboardExecuteRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="dashboardExecuteRequest"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;DashboardExecuteResult&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<DashboardExecuteResult>>> ExecuteDashboardWithHttpInfoAsync(DashboardExecuteRequest dashboardExecuteRequest, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DashboardsApi : IDisposable, IDashboardsApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardsApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public DashboardsApi(Oden.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public DashboardsApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DashboardsApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public DashboardsApi(HttpClient client, Oden.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public DashboardsApi(Oden.Client.ISynchronousClient client, Oden.Client.IAsynchronousClient asyncClient, Oden.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <summary>
        /// Execute a dashboard Execute every module in a dashboard with shared time-range and filter overrides, returning the columns and rows produced by each module.  Modules execute in parallel and are reported in the dashboard&#39;s stored module order. Per-module failures (parse, dispatch) land in the &#x60;error&#x60; field of that module&#39;s result; siblings continue to run.  Known v1 limitations: - Template variables (&#x60;{var_name}&#x60; in stored OQL) are not substituted   server-side. Modules containing unsubstituted placeholders will   fail at parse time. 
        /// </summary>
        /// <exception cref="Oden.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dashboardExecuteRequest"></param>
        /// <returns>List&lt;DashboardExecuteResult&gt;</returns>
        public List<DashboardExecuteResult> ExecuteDashboard(DashboardExecuteRequest dashboardExecuteRequest)
        {
            Oden.Client.ApiResponse<List<DashboardExecuteResult>> localVarResponse = ExecuteDashboardWithHttpInfo(dashboardExecuteRequest);
        ...
        /// <param name="dashboardExecuteRequest"></param>
        /// <returns>ApiResponse of List&lt;DashboardExecuteResult&gt;</returns>
        public Oden.Client.ApiResponse<List<DashboardExecuteResult>> ExecuteDashboardWithHttpInfo(DashboardExecuteRequest dashboardExecuteRequest)
        {
            // verify the required parameter 'dashboardExecuteRequest' is set
            if (dashboardExecuteRequest == null)
                throw new Oden.Client.ApiException(400, "Missing required parameter 'dashboardExecuteRequest' when calling DashboardsApi->ExecuteDashboard");
            ...
            localVarRequestOptions.Data = dashboardExecuteRequest;
            ...
            var localVarResponse = this.Client.Post<List<DashboardExecuteResult>>("/v2/dashboard/execute", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ExecuteDashboard", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;DashboardExecuteResult&gt;</returns>
        public async System.Threading.Tasks.Task<List<DashboardExecuteResult>> ExecuteDashboardAsync(DashboardExecuteRequest dashboardExecuteRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            Oden.Client.ApiResponse<List<DashboardExecuteResult>> localVarResponse = await ExecuteDashboardWithHttpInfoAsync(dashboardExecuteRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;DashboardExecuteResult&gt;)</returns>
        public async System.Threading.Tasks.Task<Oden.Client.ApiResponse<List<DashboardExecuteResult>>> ExecuteDashboardWithHttpInfoAsync(DashboardExecuteRequest dashboardExecuteRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'dashboardExecuteRequest' is set
            if (dashboardExecuteRequest == null)
                throw new Oden.Client.ApiException(400, "Missing required parameter 'dashboardExecuteRequest' when calling DashboardsApi->ExecuteDashboard");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<DashboardExecuteResult>>("/v2/dashboard/execute", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
