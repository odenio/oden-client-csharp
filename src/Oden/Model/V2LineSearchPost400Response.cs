...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_line_search_post_400_response")]
    public partial class V2LineSearchPost400Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2LineSearchPost400Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2LineSearchPost400Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2LineSearchPost400Response" /> class.
        /// </summary>
        ...
        public V2LineSearchPost400Response(string error = default, string name = default, bool retryable = default)
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for V2LineSearchPost400Response and cannot be null");
            }
            this.Error = error;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for V2LineSearchPost400Response and cannot be null");
            }
            this.Name = name;
