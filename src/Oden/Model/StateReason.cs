...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateReason")]
    public partial class StateReason : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateReason" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public StateReason(int id = default, string name = default)
        {
            this.Id = id;
            this.Name = name;
        }
