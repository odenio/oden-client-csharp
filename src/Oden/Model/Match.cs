...
namespace Oden.Model
{
    ...
    /// </summary>
    /// <value>Describes which item(s) to match when searching for an entity: - &#x60;unique&#x60; (default): will return an error if the search object matches multiple entities - &#x60;all&#x60;: will return every item that matches search entity - &#x60;last&#x60;: will return the most recent object, where applicable - &#x60;first&#x60;: will return the least recent object, where applicable </value>
