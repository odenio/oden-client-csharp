...
namespace Oden.Model
{
    ...
    public partial class GenericError : IValidatableObject
    {
        ...
        public GenericError(string error = default, bool retryable = default)
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for GenericError and cannot be null");
            }
            this.Error = error;
