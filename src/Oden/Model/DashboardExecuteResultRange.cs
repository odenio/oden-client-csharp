...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteResult_range")]
    public partial class DashboardExecuteResultRange : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteResultRange" /> class.
        /// </summary>
        /// <param name="start">start.</param>
        /// <param name="end">end.</param>
        public DashboardExecuteResultRange(DateTime start = default, DateTime end = default)
        {
            this.Start = start;
            this.End = end;
        }
