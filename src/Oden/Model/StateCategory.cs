...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StateCategory")]
    public partial class StateCategory : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateCategory" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public StateCategory(int id = default, string name = default)
        {
            this.Id = id;
            this.Name = name;
        }
