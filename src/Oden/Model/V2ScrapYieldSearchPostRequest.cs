...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_scrap_yield_search_post_request")]
    public partial class V2ScrapYieldSearchPostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ScrapYieldSearchPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2ScrapYieldSearchPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ScrapYieldSearchPostRequest" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="interval">interval (required).</param>
        public V2ScrapYieldSearchPostRequest(ScrapYieldData data = default, Interval interval = default)
        {
            // to ensure "interval" is required (not null)
            if (interval == null)
            {
                throw new ArgumentNullException("interval is a required property for V2ScrapYieldSearchPostRequest and cannot be null");
            }
