...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IntervalType")]
    public partial class IntervalType : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IntervalType" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="factory">factory.</param>
        /// <param name="name">name.</param>
        /// <param name="match">match.</param>
        public IntervalType(Guid id = default, Factory factory = default, string name = default, Match? match = default)
        {
            this.Id = id;
