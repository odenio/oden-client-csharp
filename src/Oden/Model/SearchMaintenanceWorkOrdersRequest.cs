...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "search_maintenance_work_orders_request")]
    public partial class SearchMaintenanceWorkOrdersRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchMaintenanceWorkOrdersRequest" /> class.
        /// </summary>
        ...
        public SearchMaintenanceWorkOrdersRequest(Guid id = default, string externalId = default, Line line = default, DateTime startTime = default, DateTime endTime = default, Match? match = default)
        {
            this.Id = id;
