...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "search_scrap_yield_request")]
    public partial class SearchScrapYieldRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchScrapYieldRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchScrapYieldRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchScrapYieldRequest" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="interval">interval (required).</param>
        public SearchScrapYieldRequest(ScrapYieldData data = default, Interval interval = default)
        {
            // to ensure "interval" is required (not null)
            if (interval == null)
            {
                throw new ArgumentNullException("interval is a required property for SearchScrapYieldRequest and cannot be null");
            }
