...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "search_lines_409_response")]
    public partial class SearchLines409Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchLines409Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchLines409Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchLines409Response" /> class.
        /// </summary>
        ...
        public SearchLines409Response(string entityName = default, int numMatches = default, string error = default, bool retryable = default)
        {
            // to ensure "entityName" is required (not null)
            if (entityName == null)
            {
                throw new ArgumentNullException("entityName is a required property for SearchLines409Response and cannot be null");
            }
            ...
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for SearchLines409Response and cannot be null");
            }
            this.Error = error;
