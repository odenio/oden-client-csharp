...
namespace Oden.Model
{
    ...
    public partial class ProductAttribute : IValidatableObject
    {
        ...
        /// <param name="ruleBased">ruleBased.</param>
        /// <param name="match">match.</param>
        public ProductAttribute(Guid id = default, string name = default, string displayName = default, string value = default, Product product = default, bool ruleBased = default, Match? match = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets RuleBased
        /// </summary>
        [DataMember(Name = "rule_based", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RuleBased: ").Append(RuleBased).Append("\n");
