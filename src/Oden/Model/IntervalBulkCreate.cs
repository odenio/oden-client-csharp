...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IntervalBulkCreate")]
    public partial class IntervalBulkCreate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntervalBulkCreate" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="line">line.</param>
        /// <param name="intervals">intervals.</param>
        public IntervalBulkCreate(IntervalType type = default, Line line = default, List<Interval> intervals = default)
        {
            this.Type = type;
            this.Line = line;
