...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bulk_delete_quality_tests_request")]
    public partial class BulkDeleteQualityTestsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkDeleteQualityTestsRequest" /> class.
        /// </summary>
        /// <param name="ids">ids.</param>
        /// <param name="line">line.</param>
        /// <param name="startTime">startTime.</param>
        /// <param name="endTime">endTime.</param>
        public BulkDeleteQualityTestsRequest(List<Guid> ids = default, Line line = default, DateTime startTime = default, DateTime endTime = default)
        {
            this.Ids = ids;
            this.Line = line;
