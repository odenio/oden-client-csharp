...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_line_search_post_500_response")]
    public partial class V2LineSearchPost500Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2LineSearchPost500Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2LineSearchPost500Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2LineSearchPost500Response" /> class.
        /// </summary>
        ...
        public V2LineSearchPost500Response(string error = default, bool retryable = default, Guid id = default)
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for V2LineSearchPost500Response and cannot be null");
            }
            this.Error = error;
