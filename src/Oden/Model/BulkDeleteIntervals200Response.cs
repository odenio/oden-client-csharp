...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bulk_delete_intervals_200_response")]
    public partial class BulkDeleteIntervals200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkDeleteIntervals200Response" /> class.
        /// </summary>
        /// <param name="numDeleted">numDeleted.</param>
        /// <param name="failedIntervals">failedIntervals.</param>
        public BulkDeleteIntervals200Response(int numDeleted = default, List<string> failedIntervals = default)
        {
