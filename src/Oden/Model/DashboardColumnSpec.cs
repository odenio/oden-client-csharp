...
namespace Oden.Model
{
    ...
    /// DashboardColumnSpec
    /// </summary>
    [DataContract(Name = "DashboardColumnSpec")]
    public partial class DashboardColumnSpec : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardColumnSpec" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DashboardColumnSpec() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardColumnSpec" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="type">type (required).</param>
        public DashboardColumnSpec(string name = default, TypeEnum type = default)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DashboardColumnSpec and cannot be null");
            }
            this.Name = name;
            this.Type = type;
        }
