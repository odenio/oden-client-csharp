...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteFilters_states")]
    public partial class DashboardExecuteFiltersStates : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteFiltersStates" /> class.
        /// </summary>
        /// <param name="stateTypes">stateTypes.</param>
        /// <param name="stateCategoryAndReasons">stateCategoryAndReasons.</param>
        public DashboardExecuteFiltersStates(List<string> stateTypes = default, List<DashboardExecuteFiltersStatesStateCategoryAndReasonsInner> stateCategoryAndReasons = default)
        {
        ...
        /// <summary>
        /// Gets or Sets StateTypes
        /// </summary>
        [DataMember(Name = "state_types", EmitDefaultValue = false)]
        public List<string> StateTypes { get; set; }

        /// <summary>
        /// Gets or Sets StateCategoryAndReasons
        /// </summary>
        [DataMember(Name = "state_category_and_reasons", EmitDefaultValue = false)]
        public List<DashboardExecuteFiltersStatesStateCategoryAndReasonsInner> StateCategoryAndReasons { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StateTypes: ").Append(StateTypes).Append("\n");
            sb.Append("  StateCategoryAndReasons: ").Append(StateCategoryAndReasons).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
