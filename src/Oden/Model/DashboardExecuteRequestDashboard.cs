...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteRequest_dashboard")]
    public partial class DashboardExecuteRequestDashboard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteRequestDashboard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DashboardExecuteRequestDashboard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteRequestDashboard" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        public DashboardExecuteRequestDashboard(Guid id = default)
        {
            this.Id = id;
        }
