...
namespace Oden.Model
{
    ...
    public partial class MetricGroup : IValidatableObject
    {
        ...
        /// <param name="unitKindOfQuantity">unitKindOfQuantity.</param>
        /// <param name="match">match.</param>
        public MetricGroup(string name = default, string description = default, Guid id = default, string unitKindOfQuantity = default, Match? match = default)
        {
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets UnitKindOfQuantity
        /// </summary>
        [DataMember(Name = "unit_kind_of_quantity", EmitDefaultValue = false)]
        public string UnitKindOfQuantity { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UnitKindOfQuantity: ").Append(UnitKindOfQuantity).Append("\n");
