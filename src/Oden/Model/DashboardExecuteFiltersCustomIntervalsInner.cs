...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteFilters_custom_intervals_inner")]
    public partial class DashboardExecuteFiltersCustomIntervalsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteFiltersCustomIntervalsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DashboardExecuteFiltersCustomIntervalsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteFiltersCustomIntervalsInner" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="valueContains">valueContains (required).</param>
        public DashboardExecuteFiltersCustomIntervalsInner(string type = default, string valueContains = default)
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for DashboardExecuteFiltersCustomIntervalsInner and cannot be null");
            }
            this.Type = type;
            // to ensure "valueContains" is required (not null)
            if (valueContains == null)
            {
                throw new ArgumentNullException("valueContains is a required property for DashboardExecuteFiltersCustomIntervalsInner and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "value_contains", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ValueContains: ").Append(ValueContains).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
