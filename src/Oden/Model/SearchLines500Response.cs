...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "search_lines_500_response")]
    public partial class SearchLines500Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchLines500Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchLines500Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchLines500Response" /> class.
        /// </summary>
        ...
        public SearchLines500Response(string error = default, bool retryable = default, Guid id = default)
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for SearchLines500Response and cannot be null");
            }
            this.Error = error;
