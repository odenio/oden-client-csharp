...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteFilters_lines_inner")]
    public partial class DashboardExecuteFiltersLinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteFiltersLinesInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public DashboardExecuteFiltersLinesInner(Guid id = default, string name = default)
        {
            this.Id = id;
            this.Name = name;
        }
