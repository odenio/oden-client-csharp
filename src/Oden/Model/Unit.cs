...
namespace Oden.Model
{
    ...
    public partial class Unit : IValidatableObject
    {
        ...
        /// <param name="kindOfQuantity">kindOfQuantity.</param>
        public Unit(int id = default, string symbol = default, string name = default, string kindOfQuantity = default)
        {
            this.Id = id;
            this.Symbol = symbol;
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets KindOfQuantity
        /// </summary>
        [DataMember(Name = "kind_of_quantity", EmitDefaultValue = false)]
        public string KindOfQuantity { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  KindOfQuantity: ").Append(KindOfQuantity).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
