...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteRange")]
    public partial class DashboardExecuteRange : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteRange" /> class.
        /// </summary>
        /// <param name="start">start.</param>
        /// <param name="end">end.</param>
        /// <param name="anchor">Anchor expression for a relative range, e.g. &#x60;now&#x60;..</param>
        /// <param name="offset">Offset expression for a relative range, e.g. &#x60;-7D&#x60;..</param>
        /// <param name="timezone">IANA timezone identifier (defaults to UTC)..</param>
        public DashboardExecuteRange(DateTime start = default, DateTime end = default, string anchor = default, string offset = default, string timezone = default)
        {
            this.Start = start;
            this.End = end;
            this.Anchor = anchor;
        ...
        /// </summary>
        /// <value>Anchor expression for a relative range, e.g. &#x60;now&#x60;.</value>
        ...
        /// </summary>
        /// <value>Offset expression for a relative range, e.g. &#x60;-7D&#x60;.</value>
        ...
        /// </summary>
        /// <value>IANA timezone identifier (defaults to UTC).</value>
