...
namespace Oden.Model
{
    ...
    public partial class Target : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="metricGroup">metricGroup.</param>
        ...
        public Target(MetricGroup metricGroup = default, Product product = default, Line line = default, double targetValue = default, double lsl = default, double usl = default, Match? match = default)
        {
        ...
        /// <summary>
        /// Gets or Sets MetricGroup
        /// </summary>
        [DataMember(Name = "metric_group", EmitDefaultValue = false)]
        public MetricGroup MetricGroup { get; set; }
        ...
        /// Gets or Sets Lsl
        /// </summary>
        [DataMember(Name = "lsl", EmitDefaultValue = false)]
        public double Lsl { get; set; }

        /// <summary>
        /// Gets or Sets Usl
        /// </summary>
        [DataMember(Name = "usl", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Lsl: ").Append(Lsl).Append("\n");
            sb.Append("  Usl: ").Append(Usl).Append("\n");
