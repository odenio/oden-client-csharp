...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bulk_update_intervals_200_response")]
    public partial class BulkUpdateIntervals200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateIntervals200Response" /> class.
        /// </summary>
        ...
        public BulkUpdateIntervals200Response(int numUpdated = default, List<Interval> updatedIntervals = default, int numFailed = default, List<BulkUpdateIntervals200ResponseFailedIntervalsInner> failedIntervals = default)
        {
        ...
        public List<BulkUpdateIntervals200ResponseFailedIntervalsInner> FailedIntervals { get; set; }
