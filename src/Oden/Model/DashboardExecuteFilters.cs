...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteFilters")]
    public partial class DashboardExecuteFilters : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteFilters" /> class.
        /// </summary>
        /// <param name="lines">Lines to restrict to. Each entry must supply &#x60;id&#x60;, &#x60;name&#x60;, or both; entries that supply neither are rejected. Other Line fields (factory, secondary_name, match) are not used here and are intentionally omitted so generated clients don&#39;t suggest them as inputs. .</param>
        /// <param name="shifts">shifts.</param>
        /// <param name="productIds">productIds.</param>
        /// <param name="productAttributeValueIds">productAttributeValueIds.</param>
        /// <param name="scrapCategories">scrapCategories.</param>
        /// <param name="states">states.</param>
        /// <param name="customIntervals">customIntervals.</param>
        public DashboardExecuteFilters(List<DashboardExecuteFiltersLinesInner> lines = default, List<int> shifts = default, List<Guid> productIds = default, List<Guid> productAttributeValueIds = default, List<Guid> scrapCategories = default, DashboardExecuteFiltersStates states = default, List<DashboardExecuteFiltersCustomIntervalsInner> customIntervals = default)
        {
            this.Lines = lines;
            this.Shifts = shifts;
        ...
        /// </summary>
        /// <value>Lines to restrict to. Each entry must supply &#x60;id&#x60;, &#x60;name&#x60;, or both; entries that supply neither are rejected. Other Line fields (factory, secondary_name, match) are not used here and are intentionally omitted so generated clients don&#39;t suggest them as inputs. </value>
        [DataMember(Name = "lines", EmitDefaultValue = false)]
        public List<DashboardExecuteFiltersLinesInner> Lines { get; set; }
        ...
        /// <summary>
        /// Gets or Sets ProductAttributeValueIds
        /// </summary>
        [DataMember(Name = "product_attribute_value_ids", EmitDefaultValue = false)]
        public List<Guid> ProductAttributeValueIds { get; set; }

        /// <summary>
        /// Gets or Sets ScrapCategories
        /// </summary>
        [DataMember(Name = "scrap_categories", EmitDefaultValue = false)]
        public List<Guid> ScrapCategories { get; set; }

        /// <summary>
        /// Gets or Sets States
        /// </summary>
        [DataMember(Name = "states", EmitDefaultValue = false)]
        public DashboardExecuteFiltersStates States { get; set; }

        /// <summary>
        /// Gets or Sets CustomIntervals
        /// </summary>
        [DataMember(Name = "custom_intervals", EmitDefaultValue = false)]
        public List<DashboardExecuteFiltersCustomIntervalsInner> CustomIntervals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProductAttributeValueIds: ").Append(ProductAttributeValueIds).Append("\n");
            sb.Append("  ScrapCategories: ").Append(ScrapCategories).Append("\n");
            sb.Append("  States: ").Append(States).Append("\n");
            sb.Append("  CustomIntervals: ").Append(CustomIntervals).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
