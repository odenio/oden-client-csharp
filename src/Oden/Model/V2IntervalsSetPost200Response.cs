...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_intervals_set_post_200_response")]
    public partial class V2IntervalsSetPost200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2IntervalsSetPost200Response" /> class.
        /// </summary>
        /// <param name="intervalIds">intervalIds.</param>
        public V2IntervalsSetPost200Response(List<string> intervalIds = default)
        {
            this.IntervalIds = intervalIds;
        }

        /// <summary>
        /// Gets or Sets IntervalIds
        /// </summary>
        [DataMember(Name = "interval_ids", EmitDefaultValue = false)]
        public List<string> IntervalIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IntervalIds: ").Append(IntervalIds).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
