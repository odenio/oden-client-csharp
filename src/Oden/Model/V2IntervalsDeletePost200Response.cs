...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_intervals_delete_post_200_response")]
    public partial class V2IntervalsDeletePost200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2IntervalsDeletePost200Response" /> class.
        /// </summary>
        /// <param name="numDeleted">numDeleted.</param>
        /// <param name="failedIntervals">failedIntervals.</param>
        public V2IntervalsDeletePost200Response(int numDeleted = default, List<string> failedIntervals = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "num_deleted", EmitDefaultValue = false)]
        ...
        public List<string> FailedIntervals { get; set; }
