...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_scrap_yield_set_post_request")]
    public partial class V2ScrapYieldSetPostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ScrapYieldSetPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2ScrapYieldSetPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2ScrapYieldSetPostRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="interval">interval (required).</param>
        public V2ScrapYieldSetPostRequest(ScrapYieldData data = default, Interval interval = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for V2ScrapYieldSetPostRequest and cannot be null");
            }
            this.Data = data;
            // to ensure "interval" is required (not null)
            if (interval == null)
            {
                throw new ArgumentNullException("interval is a required property for V2ScrapYieldSetPostRequest and cannot be null");
            }
        ...
        public ScrapYieldData Data { get; set; }
