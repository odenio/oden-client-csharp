...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScrapYieldData")]
    public partial class ScrapYieldData : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrapYieldData" /> class.
        /// </summary>
        ...
        public ScrapYieldData(string rawData = default, Guid id = default, ScrapYieldSchema schema = default, DateTime? timestamp = default, Match? match = default)
        {
        ...
        public ScrapYieldSchema Schema { get; set; }
