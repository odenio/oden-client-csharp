...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QualityTest")]
    public partial class QualityTest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QualityTest" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="rawData">rawData.</param>
        /// <param name="timestamp">timestamp.</param>
        /// <param name="interval">interval.</param>
        /// <param name="qualitySchema">qualitySchema.</param>
        /// <param name="match">match.</param>
        public QualityTest(Guid id = default, Object rawData = default, DateTime timestamp = default, Interval interval = default, QualitySchema qualitySchema = default, Match? match = default)
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets QualitySchema
        /// </summary>
        [DataMember(Name = "quality_schema", EmitDefaultValue = false)]
        public QualitySchema QualitySchema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  QualitySchema: ").Append(QualitySchema).Append("\n");
