...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OQLQuery")]
    public partial class OQLQuery : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OQLQuery" /> class.
        /// </summary>
        ...
        public OQLQuery(string query = default)
        {
            // to ensure "query" is required (not null)
            if (query == null)
            {
                throw new ArgumentNullException("query is a required property for OQLQuery and cannot be null");
            }
            this.Query = query;
        }
