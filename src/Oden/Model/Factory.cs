...
namespace Oden.Model
{
    ...
    public partial class Factory : IValidatableObject
    {
        ...
        public Factory(Guid id = default, string name = default, string secondaryName = default, string timezone = default, Match? match = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        /// </summary>
        [DataMember(Name = "secondary_name", EmitDefaultValue = true)]
