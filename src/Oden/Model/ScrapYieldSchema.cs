...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScrapYieldSchema")]
    public partial class ScrapYieldSchema : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrapYieldSchema" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="factory">factory.</param>
        /// <param name="scrapConversionFactor">scrapConversionFactor.</param>
        /// <param name="scrapUnit">scrapUnit.</param>
        /// <param name="yieldConversionFactor">yieldConversionFactor.</param>
        /// <param name="yieldUnit">yieldUnit.</param>
        public ScrapYieldSchema(Guid id = default, Factory factory = default, double scrapConversionFactor = default, Unit scrapUnit = default, double yieldConversionFactor = default, Unit yieldUnit = default)
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets ScrapConversionFactor
        /// </summary>
        [DataMember(Name = "scrap_conversion_factor", EmitDefaultValue = false)]
        public double ScrapConversionFactor { get; set; }

        /// <summary>
        /// Gets or Sets ScrapUnit
        /// </summary>
        [DataMember(Name = "scrap_unit", EmitDefaultValue = false)]
        public Unit ScrapUnit { get; set; }

        /// <summary>
        /// Gets or Sets YieldConversionFactor
        /// </summary>
        [DataMember(Name = "yield_conversion_factor", EmitDefaultValue = false)]
        public double YieldConversionFactor { get; set; }

        /// <summary>
        /// Gets or Sets YieldUnit
        /// </summary>
        [DataMember(Name = "yield_unit", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ScrapConversionFactor: ").Append(ScrapConversionFactor).Append("\n");
            sb.Append("  ScrapUnit: ").Append(ScrapUnit).Append("\n");
            sb.Append("  YieldConversionFactor: ").Append(YieldConversionFactor).Append("\n");
            sb.Append("  YieldUnit: ").Append(YieldUnit).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
