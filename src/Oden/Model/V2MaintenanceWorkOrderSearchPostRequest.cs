...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_maintenance_work_order_search_post_request")]
    public partial class V2MaintenanceWorkOrderSearchPostRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V2MaintenanceWorkOrderSearchPostRequest" /> class.
        /// </summary>
        ...
        public V2MaintenanceWorkOrderSearchPostRequest(Guid id = default, string externalId = default, Line line = default, DateTime startTime = default, DateTime endTime = default, Match? match = default)
        {
            this.Id = id;
