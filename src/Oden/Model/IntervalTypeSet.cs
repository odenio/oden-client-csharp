...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IntervalTypeSet")]
    public partial class IntervalTypeSet : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntervalTypeSet" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="metadataSchema">metadataSchema.</param>
        /// <param name="tags">tags.</param>
        public IntervalTypeSet(Guid id = default, string name = default, string metadataSchema = default, List<string> tags = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets MetadataSchema
        /// </summary>
        [DataMember(Name = "metadata_schema", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MetadataSchema: ").Append(MetadataSchema).Append("\n");
