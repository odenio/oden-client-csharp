...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IntervalBulkUpdate")]
    public partial class IntervalBulkUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntervalBulkUpdate" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="line">line.</param>
        /// <param name="intervals">intervals.</param>
        public IntervalBulkUpdate(IntervalType type = default, Line line = default, List<Interval> intervals = default)
        {
            this.Type = type;
            this.Line = line;
