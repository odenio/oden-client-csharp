...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MaintenanceWorkOrder")]
    public partial class MaintenanceWorkOrder : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceWorkOrder" /> class.
        /// </summary>
        ...
        public MaintenanceWorkOrder(Guid id = default, string name = default, string description = default, string externalId = default, Line line = default, DateTime startedAt = default, DateTime completedAt = default, Dictionary<string, Object> metadata = default, Match? match = default)
        {
            this.Id = id;
            this.Name = name;
