...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteFilters_states_state_category_and_reasons_inner")]
    public partial class DashboardExecuteFiltersStatesStateCategoryAndReasonsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteFiltersStatesStateCategoryAndReasonsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DashboardExecuteFiltersStatesStateCategoryAndReasonsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteFiltersStatesStateCategoryAndReasonsInner" /> class.
        /// </summary>
        /// <param name="stateCategory">stateCategory (required).</param>
        /// <param name="stateReason">stateReason.</param>
        public DashboardExecuteFiltersStatesStateCategoryAndReasonsInner(int stateCategory = default, string stateReason = default)
        {
        ...
        /// <summary>
        /// Gets or Sets StateCategory
        /// </summary>
        [DataMember(Name = "state_category", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StateCategory: ").Append(StateCategory).Append("\n");
