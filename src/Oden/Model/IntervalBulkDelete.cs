...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IntervalBulkDelete")]
    public partial class IntervalBulkDelete : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntervalBulkDelete" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="line">line.</param>
        /// <param name="startTime">startTime.</param>
        /// <param name="endTime">endTime.</param>
        /// <param name="hardDelete">hardDelete (default to true).</param>
        public IntervalBulkDelete(IntervalType type = default, Line line = default, DateTime startTime = default, DateTime endTime = default, bool hardDelete = true)
        {
            this.Type = type;
            this.Line = line;
        ...
        /// </summary>
        [DataMember(Name = "hard_delete", EmitDefaultValue = true)]
