...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bulk_update_intervals_200_response_failed_intervals_inner")]
    public partial class BulkUpdateIntervals200ResponseFailedIntervalsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateIntervals200ResponseFailedIntervalsInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="error">error.</param>
        public BulkUpdateIntervals200ResponseFailedIntervalsInner(string id = default, string error = default)
        {
            this.Id = id;
            this.Error = error;
        }
