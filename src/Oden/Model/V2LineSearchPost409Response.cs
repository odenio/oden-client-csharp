...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_line_search_post_409_response")]
    public partial class V2LineSearchPost409Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2LineSearchPost409Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2LineSearchPost409Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2LineSearchPost409Response" /> class.
        /// </summary>
        ...
        public V2LineSearchPost409Response(string entityName = default, int numMatches = default, string error = default, bool retryable = default)
        {
            // to ensure "entityName" is required (not null)
            if (entityName == null)
            {
                throw new ArgumentNullException("entityName is a required property for V2LineSearchPost409Response and cannot be null");
            }
            ...
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for V2LineSearchPost409Response and cannot be null");
            }
            this.Error = error;
        ...
        /// </summary>
        [DataMember(Name = "entity_name", IsRequired = true, EmitDefaultValue = true)]
