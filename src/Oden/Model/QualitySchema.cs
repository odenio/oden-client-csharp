...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QualitySchema")]
    public partial class QualitySchema : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QualitySchema" /> class.
        /// </summary>
        ...
        public QualitySchema(string id = default, Factory factory = default, string schema = default, string description = default, Match? match = default)
        {
            this.Id = id;
