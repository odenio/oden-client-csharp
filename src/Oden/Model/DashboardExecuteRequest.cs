...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DashboardExecuteRequest")]
    public partial class DashboardExecuteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DashboardExecuteRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardExecuteRequest" /> class.
        /// </summary>
        ...
        public DashboardExecuteRequest(DashboardExecuteRequestDashboard dashboard = default, DashboardExecuteRange range = default, DashboardExecuteFilters filters = default)
        {
            // to ensure "dashboard" is required (not null)
            if (dashboard == null)
            {
                throw new ArgumentNullException("dashboard is a required property for DashboardExecuteRequest and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "dashboard", IsRequired = true, EmitDefaultValue = true)]
        public DashboardExecuteRequestDashboard Dashboard { get; set; }

        /// <summary>
        /// Gets or Sets Range
        /// </summary>
        [DataMember(Name = "range", EmitDefaultValue = false)]
        public DashboardExecuteRange Range { get; set; }

        /// <summary>
        /// Gets or Sets Filters
        /// </summary>
        [DataMember(Name = "filters", EmitDefaultValue = false)]
        public DashboardExecuteFilters Filters { get; set; }
