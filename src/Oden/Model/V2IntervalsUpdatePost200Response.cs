...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_intervals_update_post_200_response")]
    public partial class V2IntervalsUpdatePost200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2IntervalsUpdatePost200Response" /> class.
        /// </summary>
        /// <param name="numUpdated">numUpdated.</param>
        /// <param name="updatedIntervals">updatedIntervals.</param>
        /// <param name="numFailed">numFailed.</param>
        /// <param name="failedIntervals">failedIntervals.</param>
        public V2IntervalsUpdatePost200Response(int numUpdated = default, List<Interval> updatedIntervals = default, int numFailed = default, List<V2IntervalsUpdatePost200ResponseFailedIntervalsInner> failedIntervals = default)
        {
        ...
        /// <summary>
        /// Gets or Sets NumUpdated
        /// </summary>
        [DataMember(Name = "num_updated", EmitDefaultValue = false)]
        public int NumUpdated { get; set; }

        /// <summary>
        /// Gets or Sets UpdatedIntervals
        /// </summary>
        [DataMember(Name = "updated_intervals", EmitDefaultValue = false)]
        public List<Interval> UpdatedIntervals { get; set; }

        /// <summary>
        /// Gets or Sets NumFailed
        /// </summary>
        [DataMember(Name = "num_failed", EmitDefaultValue = false)]
        public int NumFailed { get; set; }

        /// <summary>
        /// Gets or Sets FailedIntervals
        /// </summary>
        [DataMember(Name = "failed_intervals", EmitDefaultValue = false)]
        public List<V2IntervalsUpdatePost200ResponseFailedIntervalsInner> FailedIntervals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NumUpdated: ").Append(NumUpdated).Append("\n");
            sb.Append("  UpdatedIntervals: ").Append(UpdatedIntervals).Append("\n");
            sb.Append("  NumFailed: ").Append(NumFailed).Append("\n");
            sb.Append("  FailedIntervals: ").Append(FailedIntervals).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
