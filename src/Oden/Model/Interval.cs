...
namespace Oden.Model
{
    ...
    public partial class Interval : IValidatableObject
    {
        ...
        public Interval(string id = default, IntervalType type = default, string name = default, Line line = default, DateTime startTime = default, DateTime endTime = default, IntervalMetadata metadata = default, Match? match = default)
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Interval and cannot be null");
            }
            this.Type = type;
            // to ensure "line" is required (not null)
            if (line == null)
            {
                throw new ArgumentNullException("line is a required property for Interval and cannot be null");
            }
            this.Line = line;
            this.Id = id;
            this.Name = name;
        ...
        public IntervalMetadata Metadata { get; set; }
