...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "set_scrap_yield_request")]
    public partial class SetScrapYieldRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetScrapYieldRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SetScrapYieldRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SetScrapYieldRequest" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="interval">interval (required).</param>
        public SetScrapYieldRequest(ScrapYieldData data = default, Interval interval = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for SetScrapYieldRequest and cannot be null");
            }
            this.Data = data;
            // to ensure "interval" is required (not null)
            if (interval == null)
            {
                throw new ArgumentNullException("interval is a required property for SetScrapYieldRequest and cannot be null");
            }
