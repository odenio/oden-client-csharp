...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductMapping")]
    public partial class ProductMapping : IValidatableObject
    {
        ...
        public ProductMapping(Product product = default, Line line = default, Match? match = default)
        {
