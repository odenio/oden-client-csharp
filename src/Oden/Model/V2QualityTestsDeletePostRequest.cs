...
namespace Oden.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v2_quality_tests_delete_post_request")]
    public partial class V2QualityTestsDeletePostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2QualityTestsDeletePostRequest" /> class.
        /// </summary>
        /// <param name="ids">ids.</param>
        /// <param name="line">line.</param>
        /// <param name="startTime">startTime.</param>
        /// <param name="endTime">endTime.</param>
        public V2QualityTestsDeletePostRequest(List<Guid> ids = default, Line line = default, DateTime startTime = default, DateTime endTime = default)
        {
            this.Ids = ids;
            this.Line = line;
